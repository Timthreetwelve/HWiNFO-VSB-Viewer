...
it.WelcomeLabel2=Questo installerà [name/ver] in questo computer.%n%nTi consigliamo, prima di continuare, di chiudere tutte le altre applicazioni.%n%n%nTieni presente che [name] richiede .NET 6.%n
